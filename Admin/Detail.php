...
$query_Recordset1 = sprintf("SELECT CustomerName, Address, Province, Email, Mobile, Gender FROM customer_registration WHERE CustomerId = %s", GetSQLValueString($colname_Recordset1, "int"));
  ...
  <div id="content">
    ...
    <table width="100%" border="0">
      ...
      <?php do { ?>
        ...
        <tr> <td bgcolor="#BDE0A8"><strong>Province</strong></td> 
        <td bgcolor="#BDE0A8"><?php echo $row_Recordset1['Province']; ?></td></tr>
